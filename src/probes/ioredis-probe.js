 ...
 * Modified by Jorgen Evens <jorgen@ambassify.com>
*
...
/**
* Probe to instrument the ioredis npm.
*
...
RedisProbe.prototype.attach = function(name, target) {
    ...
    * or client.multi()
    */
    aspect.after(target.prototype, ['multi', 'batch', 'MULTI', 'BATCH'], {}, function(
        target,
        mode,
        args,
        probeData,
